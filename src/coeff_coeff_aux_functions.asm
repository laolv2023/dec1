; coeff_aux_functions @ 0x10054d20-0x10055830
; 1095 instructions
  ...
  0x10054e2e: int3     
  0x10054e2f: int3     
  0x10054e30: xor      ecx, ecx
  0x10054e32: mov      dword ptr [eax], 0x3ff
  0x10054e38: mov      dword ptr [eax + 4], ecx
  0x10054e3b: mov      dword ptr [eax + 8], ecx
  0x10054e3e: ret      
  0x10054e3f: int3     
  0x10054e40: push     ebp
  0x10054e41: mov      ebp, esp
  0x10054e43: mov      eax, dword ptr [ebp + 8]
  0x10054e46: mov      ecx, dword ptr [eax + 0x570]
  0x10054e4c: push     ebx
  0x10054e4d: push     esi
  0x10054e4e: push     edi
  0x10054e4f: mov      edi, dword ptr [ecx + 0x1c]
  0x10054e52: add      edi, 0xd8
  0x10054e58: push     edi
  0x10054e59: push     eax
  0x10054e5a: xor      ebx, ebx
  0x10054e5c: xor      esi, esi
  0x10054e5e: call     0x10054380
  0x10054e63: add      esp, 8
  0x10054e66: test     eax, eax
  0x10054e68: jne      0x10054e93
  0x10054e6a: lea      ebx, [ebx]
  0x10054e70: inc      esi
  0x10054e71: inc      ebx
  0x10054e72: cmp      esi, 3
  0x10054e75: jl       0x10054e7c
  0x10054e77: mov      esi, 3
  0x10054e7c: mov      ecx, dword ptr [ebp + 8]
  0x10054e7f: lea      edx, [esi + esi*2]
  0x10054e82: lea      eax, [edi + edx*4]
  0x10054e85: push     eax
  0x10054e86: push     ecx
  0x10054e87: call     0x10054380
  0x10054e8c: add      esp, 8
  0x10054e8f: test     eax, eax
  0x10054e91: je       0x10054e70
  0x10054e93: pop      edi
  0x10054e94: pop      esi
  0x10054e95: mov      eax, ebx
  0x10054e97: pop      ebx
  0x10054e98: pop      ebp
  0x10054e99: ret      
  0x10054e9a: int3     
  ...
  0x10054e9f: int3     
  0x10054ea0: push     ebp
  0x10054ea1: mov      ebp, esp
  0x10054ea3: mov      eax, dword ptr [ebp + 8]
  0x10054ea6: push     eax
  0x10054ea7: call     0x10054910
  0x10054eac: dec      eax
  0x10054ead: add      esp, 4
  0x10054eb0: neg      eax
  0x10054eb2: sbb      eax, eax
  0x10054eb4: inc      eax
  0x10054eb5: pop      ebp
  0x10054eb6: ret      
  0x10054eb7: int3     
